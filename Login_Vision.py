...
def registrar_usuario():
    ...
    # Abriremos la informacion en modo escritura
...
def verificacion_login():
    ...
    if log_usuario in lista_archivos:  # Comparamos los archivos con el que nos interesa
        ...
        Label(pantalla2, text="Usuario no encontrado",
              fg="red", font=("Calibri", 11)).pack()
...
def login_facial():
    ...
    if usuario_login+".jpg" in im_archivos:  # Comparamos los archivos con el que nos interesa
        ...
        if similitud >= 0.98:
            ...
            print("Compatibilidad con la foto del registro: ", similitud)
            Label(pantalla2, text="Incompatibilidad de rostros",
                  fg="red", font=("Calibri", 11)).pack()
    else:
        print("Usuario no encontrado")
        Label(pantalla2, text="Usuario no encontrado",
...
def login():
    ...
    Button(pantalla2, text="Inicio de Sesion Tradicional",
           width=20, height=1, command=verificacion_login).pack()

    # ------------ Vamos a crear el boton para hacer el login facial --------------------
    Label(pantalla2, text="").pack()
    Button(pantalla2, text="Inicio de Sesion Facial",
           width=20, height=1, command=login_facial).pack()
...
def pantalla_principal():
    ...
    pantalla.title("Registro asistencia")  # Asignamos el titulo de la pantalla
    Label(text="Asistencia", bg="gray", width="300", height="2", font=(
        "Verdana", 13)).pack()  # Asignamos caracteristicas de la ventana
